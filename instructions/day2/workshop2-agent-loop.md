...
คำทักทายทีม NOC อย่างเป็นทางการ

สรุปภาพรวมสั้นๆ ว่าสัปดาห์นี้พบปัญหากี่เคส และเป็นระดับ High กี่เคส

แทรกข้อมูล Ticket ทั้งหมดในรูปแบบ "ตาราง" (แสดงหมายเลข, ระดับ, อุปกรณ์, และหัวข้อ)

คำลงท้ายแจ้งให้ทีมงานทราบและดำเนินการ พร้อมลงชื่อจาก "ระบบ AI Agent"
```
---
